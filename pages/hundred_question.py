...
controls = html.Div(id="hq-controls", children=[
    html.Div(className="control", children=[html.Label("Tickers", htmlFor="hq-tickers"),
        dcc.Checklist(id="hq-tickers", value=TICKERS_DEFAULT,
                      options=[{"label": t, "value": t} for t in TICKERS_DEFAULT], inline=True)]),
    html.Div(className="control", children=[html.Label("Date Range", htmlFor="hq-dates"),
        dcc.DatePickerRange(id="hq-dates",
